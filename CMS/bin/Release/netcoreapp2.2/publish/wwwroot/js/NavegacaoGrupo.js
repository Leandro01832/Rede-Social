$(document).ready(function() {
    ...
    $("#voltar").click(function() {
        ...
        window.location.href = "/Grupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" + valorAnterior;
    });

    $("#avancar").click(function() {
        redirecionar(valorProximo);
        window.location.href = "/Grupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" + valorProximo;
    });
        ...
        if ($("#automatico").is(':checked') == true) {
            ...
            setTimeout(function() {
                ...
                if (valorAtual < valorQuant){
                    ...
                    window.location.href = "/Grupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo  + "/1";
            }, tempo);
        }
        else
            $.cookie('automatico', '0');
    ...
    function BuscarStory() {
        $.ajax({
            ...
            .done(function(response) {
                ...
                if(response[0] != 0)
                window.location.href = "/Grupo/" + response[0]  + "/" + response[1] + "/" + response[2]  + "/1";
                else
                window.location.href = "/SubStory/" + valorPaginaPadraoLink + "/" + 1 + "/1";
            });
    }
