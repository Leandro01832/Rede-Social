...
namespace CMS.Migrations
{
    ...
    [Migration("20220412145804_Inicio")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("business.Back.Cor", b =>
                {
                    ...
                    b.Property<decimal>("BackgroundId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("business.Join.DivElemento", b =>
                {
                    b.Property<decimal>("DivId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal>("ElementoId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("business.business.Elementos.element.Elemento", b =>
                {
                    ...
                    b.Property<decimal?>("FormularioId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
                    ...
                    b.Property<decimal?>("PaginaEscolhida")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal>("Pagina_")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal?>("TableId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal?>("TextoId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("business.business.Elementos.element.ElementoDependenteElemento", b =>
                {
                    b.Property<decimal>("ElementoDependenteId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("business.ecommerce.ItemRequisicao", b =>
                {
                    ...
                    b.Property<decimal>("RequisicaoId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("business.business.Elementos.imagem.Imagem", b =>
                {
                    ...
                    b.Property<decimal?>("PastaImagemId")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
