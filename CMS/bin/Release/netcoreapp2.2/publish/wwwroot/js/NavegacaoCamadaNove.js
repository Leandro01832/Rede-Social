$(document).ready(function() {
    ...
    $("#voltar").click(function() {
        ...
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" +
         indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete +
          "/" + indexCamadaOito + "/" + indexCamadaNove +  "/" + valorAnterior + "/" + auto + "/" + compartilhante;
    });
    ...
    $("#avancar").click(function() {
        ...
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" +
         indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete +
          "/" + indexCamadaOito + "/" + indexCamadaNove +  "/" + valorProximo + "/" + auto + "/" + compartilhante;
    });
                ...
                if (valorAtual < valorQuant){
                    ...
                    window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
                     "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" +
                      indexCamadaSete + "/" + indexCamadaOito + "/" + indexCamadaNove +  "/" + valorProximo + "/" + auto + "/" + compartilhante;
                }
                else
                    window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
                     "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" +
                      indexCamadaSete + "/" + indexCamadaOito + "/" + indexCamadaNove +   "/1" + "/" + auto + "/" + compartilhante;
            }, tempo);
        }
        else
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
        "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete +
         "/" + indexCamadaOito + "/" + indexCamadaNove +  "/" + valorAtual + "/" + 0 + "/" + compartilhante;
    });
                 ...
                 IndiceGrupo : indexGrupo, IndiceSubGrupo : indexSubGrupo,
                  IndiceSubSubGrupo : indexSubSubGrupo, IndiceCamadaSeis : indexCamadaSeis,
                   IndiceCamadaSete : indexCamadaSete, IndiceCamadaOito : indexCamadaOito,
                    IndiceCamadaNove : indexCamadaNove }
        })
            .done(function(response) {
                $.cookie('automatico', '1');

                if(response[0] != 0)
                window.location.href = "/CamadaNove/" + response[0]  + "/" + response[1] + "/" + response[2] +
                 "/" + response[3] + "/" + response[4] + "/" + response[5] + "/" + response[6] + "/" + response[7] +
                 "/" + response[8] + "/1/"  + auto + "/" + compartilhante;
                else
                window.location.href = "/CamadaOito/" + valorPaginaPadraoLink + "/1/1/1/1/1/1/1/1/" + auto + "/" + compartilhante;
            });
    }
            ...
            if (valorAtual < valorQuant && auto == 1){
                ...
                window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink  +
                 ...
                 "/" + indexSubGrupo + "/" + indexSubSubGrupo +
                  ...
                  "/" + indexCamadaNove +  "/"  + valorProximo + "/" + auto + "/" + compartilhante;
            }
            else if (auto == 1)             
             BuscarStory();          
