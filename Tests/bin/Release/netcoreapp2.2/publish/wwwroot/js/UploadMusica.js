function uploadFiles(inputId) {
    var input = document.getElementById(inputId); var Arquivos = input.files; var formData = new FormData(); $("#imagensGaleria").css("display", "block"); for (var i = 0; i !== Arquivos.length; i++) { formData.append("files", Arquivos[i]); formData.append("Id", $("#IdentificaPagina").val()) }
