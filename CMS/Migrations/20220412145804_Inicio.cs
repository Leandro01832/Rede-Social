        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pagina_ = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<decimal>(nullable: false),
                    Pagina = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<decimal>(nullable: false),
                    PaginaEscolhida = table.Column<decimal>(nullable: true),
                    Nome = table.Column<string>(nullable: true),
                    Ordem = table.Column<int>(nullable: false),
                    Pagina_ = table.Column<decimal>(nullable: false),
                    TextoId = table.Column<decimal>(nullable: true),
                    ImagemId = table.Column<decimal>(nullable: true),
                    TableId = table.Column<decimal>(nullable: true),
                    FormularioId = table.Column<decimal>(nullable: true),
                    Discriminator = table.Column<string>(nullable: false),
                    ...
                    PastaImagemId = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoryId = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ElementoId = table.Column<decimal>(nullable: false),
                    DivId = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ElementoDependenteId = table.Column<decimal>(nullable: false),
                    ElementoId = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequisicaoId = table.Column<decimal>(nullable: false),
                    PrecoUnitario = table.Column<decimal>(nullable: false),
                    ElementoId = table.Column<decimal>(nullable: false),
                    ProdutoId = table.Column<decimal>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaginaId = table.Column<decimal>(nullable: false),
                    DivId = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundId = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
