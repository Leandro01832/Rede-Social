#pragma checksum "C:\rede-social\CMS\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f30ca5f264e9abf7afdaba899445fd122925b549"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f30ca5f264e9abf7afdaba899445fd122925b549", @"/Views/Home/Index.cshtml")]
...
<div id=""listaUrls"" style=""position:absolute; display:none; z-index:2000;"" class=""jumbotron"">
        ...
        <div class=""row"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "f30ca5f264e9abf7afdaba899445fd122925b5497769", async() => {
            }
            );
     ...
     ");
                ...
                WriteLiteral(@"      $(""#listaUrls"").append(""<p>"" +
                        ...
                        $.each(data.camadasete, function (i) {
                             var url = data.camadasete[i].url+""/1/""+compa");
                WriteLiteral(@"rtilhante;
                            $(""#listaUrls"").append(""<p>"" +
                            ""<a href='#' onclick="" + ""\""acessarStory('""+url+""');\"" >"" +
                        ...
                        $.each(data.camadanove, function (i) {
                             var url = d");
                WriteLiteral(@"ata.camadanove[i].url+""/1/""+compartilhante;
                            $(""#listaUrls"").append(""<p>"" +
                            ""<a href='#' onclick="" + ""\""acessarStory('""+url+""');\"" >"" +
                    ...
                    error: function (ex) {
                        alert('F");
                WriteLiteral("alha ao buscar urls.\' + ex);\r\n                    }\r\n                });\r\n\r\n                }\r\n\r\n            });\r\n\r\n\r\n\r\n        });\r\n</script>\r\n");
                EndContext();
            }
            );
