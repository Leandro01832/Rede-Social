$(document).ready(function() {
    ...
    $("#voltar").click(function() {
        ...
        window.location.href = "/SubStory/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + valorAnterior;
    });

    $("#avancar").click(function() {
        redirecionar(valorProximo);
        window.location.href = "/SubStory/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + valorProximo;
    });
        ...
        if ($("#automatico").is(':checked') == true) {
            ...
            setTimeout(function() {
                ...
                if (valorAtual < valorQuant){
                    ...
                    window.location.href = "/SubStory/" + valorPaginaPadraoLink + "/" + indexSubStory  + "/1";
            }, tempo);
        }
        else
            $.cookie('automatico', '0');
    ...
    function BuscarStory() {
        $.ajax({
            ...
            .done(function(response) {
                ...
                if(response[0] != 0)
                window.location.href = "/SubStory/" + response[0] + "/" + response[1] + "/1";
                else
