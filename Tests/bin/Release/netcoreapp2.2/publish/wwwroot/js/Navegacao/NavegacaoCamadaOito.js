$(document).ready(function() {
    ...
    $("#voltar").click(function() {
        ...
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" +
         indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete + "/" + indexCamadaOito + "/" + valorAnterior + "/" + auto + "/" + compartilhante;
    });

    $("#avancar").click(function() {
        redirecionar(valorProximo);
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo + "/" +
         indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete + "/" + indexCamadaOito + "/" + valorProximo + "/" + auto + "/" + compartilhante;
    });
                ...
                if (valorAtual < valorQuant){
                    ...
                    window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
                     "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" +
                      indexCamadaSete + "/" + indexCamadaOito + "/" + valorProximo + "/" + auto + "/" + compartilhante;
                }
                else
                    window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
                     "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" +
                      indexCamadaSete + "/" + indexCamadaOito +  "/1" + "/" + auto + "/" + compartilhante;
            }, tempo);
        }
        else
        window.location.href = "/SubSubGrupo/" + valorPaginaPadraoLink + "/" + indexSubStory + "/" + indexGrupo +
        "/" + indexSubGrupo + "/" + indexSubSubGrupo + "/" + indexCamadaSeis + "/" + indexCamadaSete +
         "/" + indexCamadaOito + "/" + valorAtual + "/" + 0 + "/" + compartilhante;
    });
    ...
    function BuscarStory() {
        $.ajax({
            ...
            .done(function(response) {
                ...
                if(response[0] != 0)
                window.location.href = "/CamadaOito/" + response[0]  + "/" + response[1] + "/" + response[2] +
                 "/" + response[3] + "/" + response[4] + "/" + response[5] + "/" + response[6] + "/" + response[7] + "/1/"  + auto + "/" + compartilhante;
                else
                window.location.href = "/CamadaSete/" + valorPaginaPadraoLink + "/1/1/1/1/1/1/1/" + auto + "/" + compartilhante;
            });
    }
