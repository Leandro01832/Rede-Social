#pragma checksum "C:\Users\leandro\Documents\rede-social\CMS\wwwroot\Arquivotxt\DocProducao.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "37185c22ce6c73698946e5a8f8722118c22d62b8"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"37185c22ce6c73698946e5a8f8722118c22d62b8", @"/wwwroot/Arquivotxt/DocProducao.cshtml")]
    public class wwwroot_Arquivotxt_DocProducao : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 35580, true);
         ...
         ");
            ...
            WriteLiteral(@"                                   });
                            ...
                            <form>
                                ...
                                <label>$el.ElementoDependente.Dependente.Nome</label>
                                <input class='CampoFormulario$element.Elemento.Id' id");
            WriteLiteral(@"='Campo$el.ElementoDependente.Dependente.Id' name='Campo$el.ElementoDependente.Dependente.Id' type='$el.ElementoDependente.Dependente.TipoCampo' placeholder='$el.ElementoDependente.Dependente.Placeholder' />
                                <br />
            ...
            WriteLiteral(@"  });
                        ...
                        <img class='img-responsive' src='$site$element.Elemento.ArquivoImagem' alt='imagem' style='width:${element.Elemento.Width}%;' />
                            ...
                            <a");
            WriteLiteral(@" href='#' id='LinkPadrao'  > ${element.Elemento.Texto.PalavrasTexto} </a>
                            #end
                            ...
                            <table class='$element.Elemento.EstiloTabela'>
                                ...
                                <tr class='linhaProduto' id='Produto$prod.ElementoDependente.Dependente.Id' data-value='$prod.ElementoDependente.Dependente.Id'>
                                    <th>
       ");
            WriteLiteral(@"                                 <label>$prod.ElementoDependente.Dependente.Nome</label>
                                    </th>
                                    <th>
                                        #set($imgIndice = 0)
...
");
   ...
   ");
            WriteLiteral(@"                             #end
                ...
                <div id='elemento${element.Elemento.Id}Pagina${model.Pagina.Id}' class='Elemento grid-item' data-value='$element.Elemento.Id'>
                    <div id='element${element.Elemento.Id}Pagina${model.Pagina.Id}' class='Elemento$element.Elemento.Id grid-item' data-v");
            WriteLiteral(@"alue='$element.Elemento.Id' data-id='$element.Elemento.Id'>
                                    ...
                                    <div id='Page$Page.Pagina.Id' class='item'>
                                        ...
                                        <div id='BlocoCarouselPagina$bl.Div.Id' class='BlocoCarouselPagina $bl.Div.Divisao'>
                                            ...
                                            <div id='ElementoCarouselPagina$el.Elemento.Id'>
                                             ...
                                             ");
            WriteLiteral(@"   #if ($el.Elemento.Tipo == 'Video')
            ...
            ");
            WriteLiteral(@"                                    #if($el.Elemento.Tipo == 'Link')
                                                ...
                                                #if ");
            WriteLiteral(@"($el.Elemento.Tipo == 'Imagem')
                                                ...
                                                <div id='FormCarouselPagina${el.Elemento.Id}Pagina${model.Pagina.Id}' class='grid-item'>
                                                    ...
                                                    <form>
                                                        ...
                                                        <label>$el.ElementoDependente.Dependente.Nome</label>
                                                        <inpu");
            WriteLiteral(@"t class='CampoFormulario$el.Elemento.Id' id='Campo$el.ElementoDependente.Dependente.Id' name='Campo$el.ElementoDependente.Dependente.Id' type='$el.ElementoDependente.Dependente.TipoCampo' placeholder='$el.ElementoDependente.Dependente.Placeholder' value='$el.ElementoDependente.Dependente.ValorCampo' />
                                                        <br />
        ...
        ");
            WriteLiteral(@"                            }
                        ...
                        #if ($element.Elemento.Tipo == 'Imagem')
                        <img class='img-responsive' src='$site$element.Elemento.ArquivoImagem' alt='imagem' style='width:${elem");
            WriteLiteral(@"ent.Elemento.Width}%;' />
                        #end
  ...
  ");
            WriteLiteral(@"                              <tr>
                                ...
                                <tr class='linhaProduto' id='Produto$prod.ElementoDependente.Dependente.Id' data-value='$prod.ElementoDependente.Dependente.Id'>
                                    ...
                                    <th>
                                        #set($imgIndice = 0)
                                        #foreach($img in $prod.ElementoDep");
            WriteLiteral(@"endente.Dependente.Dependentes)
                                        ...
                                        <div>
                                            <script type='text/javascript'>
                                                ...
                                                jQuery(function () {
                                                    ...
                                                    if ($('.blo");
            WriteLiteral(@"co')[0].baseURI.includes('https')) {
                                                        document.getElementById('LinksTabela').innerHTML += '<button href=# ' +
                                                            'data-value=$prod.ElementoDependente.Dependente.Id class=botaoAdicionarCarrinho ' +
                                                            '> Adicionar ao carrinho </button> ';
                                                    }
...
<style>
    ...
    #con");
            WriteLiteral(@"teudo$model.Pagina.Id {
        width: 60%;
        min-height: 1000px;
        height: auto;
        position: relative;
